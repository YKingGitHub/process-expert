...
- Work in this independent worktree: `<PROJECT_ROOT>-calc-test`
- Do not modify `<PROJECT_ROOT>` main worktree or workflow code.
...
```bash
<PROJECT_ROOT>/output/unified_extract.db
```

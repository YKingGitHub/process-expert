...
# allowed, empty list = "uncategorized" (matches the maintainer's caveat that even tags
...
def _validate_actions(rid: str, actions) -> list[str]:
    ...
    classification is ambiguous (the maintainer's caveat: even tags don't have crisp

...
```bash
# Run process_calc unit tests (33 tests)
python3 -m pytest tests/test_process_calc -q

# Run capability evaluator including Sprint C integration (7 tests)
python3 -m pytest experiments/capability_seed_expansion/tests/test_sprint_c_integration.py -q

# Full project regression (152 tests after Sprint C)
